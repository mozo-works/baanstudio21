...
(function ($, Drupal) {
  ...
  Drupal.behaviors.scrollToTop = {
    attach: function attach(context) {
      $('#btn-top, #navbar--btn-top', context).once('btn-top').on('click', function () {
  ...
  Drupal.behaviors.fixByScreen = {
    attach: function attach(context, settings) {
      $('body', context).once('responsive').each(function () {
        if (mediaDown('mbp')) {
        ...
        if (mediaDown('md')) {
          ...
          if (projectFull.length > 0) {
            $('#nav-work-types').removeClass('position-fixed').addClass('float-end').css('marginBottom', '-36px').prependTo($('#page--title'));
          } // about
        ...
        if (mediaUp('xl')) {
          ...
          var columnWidth = $('#search-input').closest('.col-lg-4').width() - (45 + 12);
  ...
  $(function () {
    ...
    if ($('#nav-work-types').length > 0) {
      ...
      $('#nav-work-types a').on('click', function (e) {
        ...
        e.preventDefault();
        var target = $($(e.currentTarget).attr('href')).offset().top - $('#nav-work-types').offset().top;
    ...
    if (!mediaDown('sm')) {
      $('.project--full .works__field-media img').on('click', function (e) {
        e.preventDefault();
        var images = Array.from(document.querySelectorAll('.works__field-media img')).map(function (img) {
          return {
            src: img.src.replace('thumbnail', 'x_large')
          };
        });
        console.log(images);
...
__webpack_require__(/*! /var/www/baanstudio21/web/themes/custom/bs21/src/js/bs21.script.js */"./src/js/bs21.script.js");
module.exports = __webpack_require__(/*! /var/www/baanstudio21/web/themes/custom/bs21/src/sass/bs21.style.scss */"./src/sass/bs21.style.scss");
