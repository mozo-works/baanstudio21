...
(function ($, Drupal) {
  ...
  function initNavbar(settings) {
    ...
    $('#navbarInner').css('minHeight', $(window).height() + 'px'); // 툴바있는 경우 하단 푸터 위치 조정.
  ...
  function resetNavbar() {
    ...
    var activeClass = 'text-dark border-bottom pb-1';
    $('#navbarSupportedContent li a').removeClass(activeClass).closest('.nav-item').removeClass('text-start');
  ...
  function activeNavbarItem(target) {
    ...
    $(target).addClass(activeClass).closest('.nav-item').addClass('text-start');
