...
/***/ "./node_modules/css-loader/index.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./src/sass/export.scss":
/*!*****************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/postcss-loader/src??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./src/sass/export.scss ***!
  \*****************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "/*!\n * Customized based on Bootstrap v5.0.0-alpha1 (https://getbootstrap.com/)\n */", ""]);
...
exports.locals = {
	...
	"font-family-base": "\"Gothic A1\", system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\"",
	"line-height-base": "2",
	"line-height-sm": "1.25",
	"line-height-lg": "2",
...
/* harmony import */ var _sass_export_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../sass/export.scss */ "./src/sass/export.scss");
/* harmony import */ var _sass_export_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_sass_export_scss__WEBPACK_IMPORTED_MODULE_1__);
...
var mediaDown = function mediaDown(breakpoint) {
  return window.matchMedia("(max-width:" + _sass_export_scss__WEBPACK_IMPORTED_MODULE_1___default.a[breakpoint] + ")").matches;
};

var mediaUp = function mediaUp(breakpoint) {
  return window.matchMedia("(min-width:" + _sass_export_scss__WEBPACK_IMPORTED_MODULE_1___default.a[breakpoint] + ")").matches;
};
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.scrollToTop = {
    attach: function attach(context) {
      $(once('btn-top', '#btn-top, #navbar--btn-top', context)).on('click', function () {
        $("html, body, #navbarSupportedContent").animate({
          scrollTop: "0px"
        });
      });
    }
  ...
  Drupal.behaviors.fixByScreen = {
    attach: function attach(context, settings) {
      $(once('responsive', 'body', context)).each(function () {
        if (mediaDown('mbp')) {
        ...
        if (mediaDown('lg')) {
          ...
          var projectBrowseNavbar = $('.block--views-block--projects-block-projects-browse-navbar');
          var projectTitles = projectBrowseNavbar.find('.project--title');

          if (projectTitles.length > 0) {
            projectTitles.each(function (i, title) {
              if ($(title).height() > 20) {
          ...
          var projectFull = $('.project--full');

          if (projectFull.length > 0) {
            $('#nav-work-types').hide();
            $('.works__field-work-type').removeClass('visually-hidden').addClass('mb-1');
          } // about


          var aboutPage = $('.body--about');
        ...
        if (mediaUp('xl')) {
          ...
          var columnWidth = $('#search-input').closest('.col-lg-4').width() - (45 + 22);
        ...
        if (mediaUp('xxl')) {
          ...
          var _columnWidth = $('#search-input').closest('.col-lg-4').width() - (58 + 8);

          $('#search-input').addClass('w-100').css({
            'maxWidth': _columnWidth + 'px',
            'position': 'absolute',
            'marginTop': '-14px'
          }).closest('.nav-item').addClass('pe-0');
  ...
  Drupal.behaviors.suffleFrontProjects = {
    attach: function attach(context, settings) {
      if (settings.path.isFront) {
        var container = $('.card--project').closest('.row').get(0); // https://stackoverflow.com/a/11972692
  ...
  $(function () {
    ...
    if ($('#nav-work-types').length > 0) {
      ...
      $('#nav-work-types a').on('click', function (e) {
        ...
        e.preventDefault();
        var target = $($(e.currentTarget).attr('href')).offset().top - $('#nav-work-types').position().top;
      ...
      $('#image-gallery img').on('click', function (e) {
        ...
        bigpicture__WEBPACK_IMPORTED_MODULE_2___default()({
          ...
          animationStart: function animationStart() {
            ...
            $('#bp_container .bp-lr svg').attr('fill', '#000').attr('height', '29px');
            $('.bp-lr').css('opacity', '1');
          },
        ...
        window.BigPicture = bigpicture__WEBPACK_IMPORTED_MODULE_2___default.a;
      }); // 프로젝트 상세 화면 제목 고정.

      if ($('.project--full').length > 0) {
        $('#page--title').addClass('position-fixed').css({
    ...
    if ($('.unpublished').length > 0) {
      $('.unpublished').each(function (index, node) {
...
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/postcss-loader/src??ref--7-2!../../node_modules/sass-loader/dist/cjs.js??ref--7-3!./export.scss */ "./node_modules/css-loader/index.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js?!./src/sass/export.scss");
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./src/js/bs21.script.js ./src/sass/bs21.style.scss ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /home/ubuntu/mozo-works/baanstudio21/web/themes/custom/bs21/src/js/bs21.script.js */"./src/js/bs21.script.js");
module.exports = __webpack_require__(/*! /home/ubuntu/mozo-works/baanstudio21/web/themes/custom/bs21/src/sass/bs21.style.scss */"./src/sass/bs21.style.scss");
